...
public class C01_dependsOnMethods extends TestBaseClass {
    ...
    //üç test methodu oluşturun.
    // 1. testin adı amazon testi olsun. amazon anasayfaya gidip amazona gittiğinizi test edin
    // 2. testin adı nutella testi olsun. nutella için arama yapıp sonuçların nutella içerdiğini test edin
    //3. testin adı arama sonuc testi olsun. sonuç sayısının 100'den fazla olduğunu test edin.
/*
